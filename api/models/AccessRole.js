  ...
  const defaultRoles = [
    {
      ...
      name: 'Viewer',
      description: 'Can view and use the agent but cannot modify it',
      resourceType: 'agent',
    ...
    },
    {
      ...
      name: 'Editor',
      description: 'Can view and modify the agent',
      resourceType: 'agent',
    ...
    },
    {
      ...
      name: 'Manager',
      description: 'Can view, modify, and delete the agent',
      resourceType: 'agent',
    ...
    },
    {
      ...
      name: 'Owner',
      description: 'Has full control over the agent including sharing it',
      resourceType: 'agent',
