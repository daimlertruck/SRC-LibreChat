...
describe('AccessRole Model Tests', () => {
  ...
  describe('seedDefaultRoles', () => {
    ...
    test('should seed default roles', async () => {
      ...
      expect(Object.keys(result).sort()).toEqual(['agent_editor', 'agent_manager', 'agent_owner', 'agent_viewer'].sort());
      ...
      const agentManagerRole = await findRoleByIdentifier('agent_manager');
      expect(agentManagerRole).toBeDefined();
      expect(agentManagerRole.permBits).toBe(RoleBits.MANAGER);
