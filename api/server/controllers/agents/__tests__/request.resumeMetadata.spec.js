...
jest.mock('@librechat/api', () => ({
  recordAgentInvocation: jest.requireActual('@librechat/api').recordAgentInvocation,
  recordAgentResponse: jest.requireActual('@librechat/api').recordAgentResponse,
  createAgentStatisticsContext: jest.requireActual('@librechat/api').createAgentStatisticsContext,
  sendEvent: jest.fn(),
