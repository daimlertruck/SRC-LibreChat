...
const mockRecordAgentResponse = jest.fn().mockResolvedValue(undefined);
const mockCreateAgentStatisticsContext = jest.fn().mockReturnValue({
  agentId: 'agent-123',
  tenantId: 'tenant-123',
...
jest.mock('@librechat/api', () => ({
  ...
  recordAgentResponse: (...args) => mockRecordAgentResponse(...args),
  createAgentStatisticsContext: (...args) => mockCreateAgentStatisticsContext(...args),
...
jest.mock('~/models', () => ({
  ...
  getAgent: jest.fn().mockResolvedValue({ id: 'agent-123' }),
